...
from .search_model_proxyless import TinyNetworkProxyless
from .search_model_snas     import TinyNetworkSNAS
...
nas201_super_nets = {'DARTS-V1': TinyNetworkDarts,
                  ...
                  'SNAS'    : TinyNetworkSNAS,
                  'ProxylessNAS' : TinyNetworkProxyless}
